...
Figure \ref{fig:feature-importance} presents the feature importance distributions for both tasks, showing the top 20 features ranked by Gini importance.
...
Figure \ref{fig:confusion-matrices} shows confusion matrix heatmaps for both tasks.
...
\begin{figure}[h]
    ...
    \caption{Confusion matrices: Reading task (left) and Interview task (right)}
...
\begin{figure}[h]
    ...
    \caption{Learning curves showing training and validation accuracy}
